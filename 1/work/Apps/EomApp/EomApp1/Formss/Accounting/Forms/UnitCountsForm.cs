...
namespace EomApp1.Formss.Accounting.Forms
{
    public partial class UnitCountsForm : Form
    {
        ...
        {
            //var sum = dataGridView1.Rows.Cast<DataGridViewRow>().Sum(
            //    c => Convert.ToInt32(c.Cells[numunitsColumn.Index].Value));

            //dataGridView1.Rows.List

            var sum = unitCountDataSet.SelectNumUnitsByPidCdCostRev.Sum(
                c => c.num_units);
