...
namespace EomApp1.Formss.Campaign.CampaignDataSetTableAdapters {
...
SELECT id, account_manager_id, campaign_status_id, ad_manager_id, advertiser_id, pid, campaign_name, campaign_type, modified, created, dt_campaign_status, dt_campaign_url, dt_allowed_country_names, is_email, is_search, is_display, is_coreg, max_scrub, notes FROM Campaign WHERE (id = SCOPE_IDENTITY())";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT        id, account_manager_id, campaign_status_id, ad_manager_id, advertiser_id, pid, campaign_name, campaign_type, modified, created, dt_campaign_status, 
                         dt_campaign_url, dt_allowed_country_names, is_email, is_search, is_display, is_coreg, max_scrub, notes
FROM            Campaign
WHERE        (dt_campaign_status = @1)";
