<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CashOut.ascx.cs"
    Inherits="Controls_Page2_CashOut" %>
...
<asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/App_Data/Data.xml"
    TransformFile="~/App_Data/Transform.xslt" XPath="data/options[@question='CashOut']/choice">
</asp:XmlDataSource>
