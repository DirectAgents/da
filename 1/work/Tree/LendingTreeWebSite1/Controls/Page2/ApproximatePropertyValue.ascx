<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ApproximatePropertyValue.ascx.cs"
    Inherits="Controls_Page2_ApproximatePropertyValue" %>
...
<%-- Data Source --%><asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/App_Data/Data.xml"
    TransformFile="~/App_Data/Transform.xslt" XPath="data/options[@question='ApproximatePropertyValue']/choice">
</asp:XmlDataSource>
