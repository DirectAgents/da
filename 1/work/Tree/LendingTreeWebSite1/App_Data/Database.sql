...
GO
print 'Created [LendingTreeAffiliateSchemaCollection] schema collection.'
GO
...
GO
print 'Created [WebLogEntry] table.'
GO
...
GO
print 'Created [WebLogEntryItem] view.'
GO
...
GO
print 'Created [ApplicationLog] view.'
GO
...
GO
print 'Created [GetLeads] table valued function.'
GO
...
GO
print 'Created [FK_WebLogEntry_EventData] foreign key constraint.'
GO
...
GO
print 'Created [FK_WebLogEntry_EventData] check constraint.'
GO
...
GO
print 'Created [FK_WebLogEntry_EventType] foreign key constraint.'
GO
...
GO
print 'Created [FK_WebLogEntry_EventType] check constraint.'
GO
